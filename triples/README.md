# Triples
This shows the result presentation of the database operation triples infered by Splendor. The json files are the raw data generated by the inference, and the following is a tidy-up of the triples that can be tainted.
